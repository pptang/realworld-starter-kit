      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xs-12 col-md-10 offset-md-1">
            ...
            <h4>{s("Eric Simons")}</h4>
            <p>
              {s("Cofounder @GoThinkster, lived in Aol's HQ for a few months, kinda looks like Peeta from the Hunger Games")}
            </p>
          ...
          <div className="articles-toggle">
            <ul className="nav nav-pills outline-active">
              <li className="nav-item">
                <a className="nav-link active" href="">{s("My Articles")}</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="">{s("Favorited Articles")}</a>
              </li>
            </ul>
          </div>
          ...
          <div className="article-preview">
            ...
            <a href="" className="preview-link">
              ...
              <ul className="tag-list">
                <li className="tag-default tag-pill tag-outline">{s("Music")}</li>
                <li className="tag-default tag-pill tag-outline">{s("Song")}</li>
              </ul>
            </a>
          </div>
